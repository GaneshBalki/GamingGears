                        ...
                        <div className="col-md-6" key={index}>
                            <table className="table table-hover" style={{ backgroundColor: '#f1f1f1', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.2)' }}>
                                ...
                                <th scope="col" colSpan="4" style={{fontSize:'1.3rem',color:'blue'}}>
                                        PC Under &#8377; {item.cpu.price + item.cpucooler.price + item.gpu.price + item.motherboard.price + item.mouse.price + item.processor.price + item.ram.price + item.ssd.price} 
                                   </th> 
                                    </tr>
                                    <tr>
                                        <th scope="col">#</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <Link to={`/products/${item.cpu.proid}`} className="text-reset" style={{ textDecoration: 'none' }}>
                                                <img src={item.cpu.url1} className="w-100" alt={item.ram.url1} style={{ height: 30, objectFit: 'contain' }} />
                                            </Link>
                                        </td>
                                        <td>
                                            <Link to={`/products/${item.cpu.proid}`} className="text-reset" style={{ textDecoration: 'none' }}>
